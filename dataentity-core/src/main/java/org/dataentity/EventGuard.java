 ...
 * Event based functionality should attempt to aquire the monitor with the 
...
public class EventGuard {
    ...
    /**
     * Will attempt to aquire the monitor. If the monitor is successfully aquired the event processing 
